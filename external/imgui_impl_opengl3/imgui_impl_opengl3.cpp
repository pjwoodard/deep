// NOLINTBEGIN(*)
    ...
    #pragma GCC diagnostic ignored "-Wsign-conversion"    // warning: implicit conversion changes signedness
...
{
    auto const * const bd = ImGui_ImplOpenGL3_GetBackendData();
...
#ifdef IMGUI_IMPL_OPENGL_MAY_HAVE_BIND_SAMPLER
    GLuint last_sampler; if (bd->GlVersion >= 330) { glGetIntegerv(GL_SAMPLER_BINDING, reinterpret_cast<GLint*>(&last_sampler)); } else { last_sampler = 0; }
#endif
...
{
    const auto * const bd = ImGui_ImplOpenGL3_GetBackendData();
